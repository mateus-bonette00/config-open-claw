...
### 4.8 `openclaw-prosaude-social-ops`
1. Para que serve: remover fundo, compor imagem e publicar no Instagram/Facebook.
2. Quando usar: erro no removebg, composicao, ou publicacao Meta.
3. Quando nao usar: tarefas sem artes/social.
4. Exemplo: `Use $openclaw-prosaude-social-ops. Corrigir falha no removeBackground.`
5. Arquivo: `/home/mateus/Documentos/Projetos/config-open-claw/.agents/skills/openclaw-prosaude-social-ops/SKILL.md`

### 4.9 `openclaw-moontech-outreach-ops`
1. Para que serve: prospeccao Moontech e integracoes HubSpot/WhatsApp/Email.
2. Quando usar: falha no outreach, ajuste de compliance, erro no HubSpot.
3. Quando nao usar: tarefas fora do Moontech.
4. Exemplo: `Use $openclaw-moontech-outreach-ops. Rodar dry-run para 3 contatos.`
5. Arquivo: `/home/mateus/Documentos/Projetos/config-open-claw/.agents/skills/openclaw-moontech-outreach-ops/SKILL.md`

### 4.10 `openclaw-deploy-live-ops`
...
### 4.11 `openclaw-google-sheets-ops`
...
### 4.12 `openclaw-gateway-tunnel-ops`
...
### 4.13 `openclaw-state-log-troubleshoot`
