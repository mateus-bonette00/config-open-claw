...
model: inherit
skills: clean-code, parallel-agents, behavioral-modes, plan-writing, brainstorming, architecture, lint-and-validate, ubuntu-home-server-ops, powershell-windows, bash-linux
---
