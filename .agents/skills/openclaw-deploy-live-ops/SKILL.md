...
2. Pasta do projeto no servidor (para onde o deploy envia): `/home/bonette/openclaw-agents` (variavel `OPENCLAW_SERVER_DIR`)
3. Config dos agentes (variaveis): `/home/bonette/openclaw-agents/.env`
4. Logs/estado: `/home/bonette/openclaw-agents/storage/logs/` e `/home/bonette/openclaw-agents/storage/state/`
5. Gateway (systemd user): `/home/bonette/.config/systemd/user/openclaw-gateway.service`
6. Open Claw (config interna): `/home/bonette/.openclaw/openclaw.json`
