...
4. Codigo do agente: `/home/bonette/openclaw-agents/agents/whatsapp-lembretes/`
5. Logs do agente: `/home/bonette/openclaw-agents/storage/logs/whatsapp-lembretes.log`
6. Estado do agente: `/home/bonette/openclaw-agents/storage/state/whatsapp-lembretes.json`
7. Config do Open Claw (plataforma): `/home/bonette/.openclaw/openclaw.json`
8. Gateway (systemd user): `/home/bonette/.config/systemd/user/openclaw-gateway.service` (porta `127.0.0.1:18789` no servidor)
...
1. `/home/bonette/openclaw-agents/agents/whatsapp-lembretes/index.js`
2. `/home/bonette/openclaw-agents/scripts/whatsapp-lembretes-command.js`
3. `/home/bonette/openclaw-agents/.env`
4. `/home/bonette/openclaw-agents/storage/logs/whatsapp-lembretes.log`
5. `/home/bonette/openclaw-agents/storage/state/whatsapp-lembretes.json`
...
3. Confirme o comando e o telefone usado.
4. Abra `/home/bonette/openclaw-agents/.env` e confira `WHATSAPP_API_URL`, `WHATSAPP_API_TOKEN`, `WHATSAPP_INSTANCE` e `WHATSAPP_LEMBRETES_OWNER_PHONE` (ou `WHATSAPP_REMINDER_DEFAULT_PHONE`).
5. Abra o log do agente: `/home/bonette/openclaw-agents/storage/logs/whatsapp-lembretes.log` (ex.: `tail -n 100 ...`).
6. Abra o estado: `/home/bonette/openclaw-agents/storage/state/whatsapp-lembretes.json` e veja `reminders`, `tasks`, `followUps`.
7. Teste o comando: `npm run wa:cmd -- "/comandos" --phone 553598183459`.
8. Se falhar, revise a funcao `handleSlashCommand` em `/home/bonette/openclaw-agents/agents/whatsapp-lembretes/index.js`, aplique a mudanca minima e teste de novo.
...
1. `cd /home/bonette/openclaw-agents && npm run wa:cmd -- "/comandos" --phone 553598183459`
2. `cd /home/bonette/openclaw-agents && node scripts/whatsapp-lembretes-command.js "/ver-comando NOME" --phone 553598183459`
3. `cd /home/bonette/openclaw-agents && node scripts/whatsapp-lembretes-command.js "/salvar-texto TITULO: conteudo" --phone 553598183459`
